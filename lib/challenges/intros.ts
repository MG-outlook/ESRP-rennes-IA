...
export const CHALLENGE_INTROS: Record<number, ChallengeIntroContent> = {
  ...
  3: {
    ...
    duration: "20 min",
    steps: [
      "On vous montre un prompt maladroit écrit pour aider Camille.",
      "Avant de voir la réponse, devinez : quel type de biais va apparaître ?",
      "Lisez la réponse biaisée de l'IA, puis réécrivez le prompt pour obtenir quelque chose de vraiment utile.",
      "Recommencez pour les 4 prompts.",
    ],
